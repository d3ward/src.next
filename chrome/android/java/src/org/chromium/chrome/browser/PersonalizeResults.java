...
+"node.innerHTML = '.showNav{margin:0!important;}.a-na-d-cb {border: none;}.a-na-d-K-A {margin: 0;}.g-na-ib-k {padding: 0;}span.FokDXb.g-Qc-s {margin: 0;padding: .4rem;}input#searchbox-input {padding: 0 .4rem;}.a-na-d-Oa {white-space: unset;}.a-na-d-K-A-w {flex-direction: column;margin: 0;}.F-x{width:100%!important}.F-k,.a-P-d,.S-Rc-qa .a-na-d{width:auto!important}.a-K-o{padding-top:8px!important}.h-a-x{text-align:center}.HWJfBb{height:90vh!important;overflow-y:scroll!important;box-shadow:0 3px 6px rgba(0,0,0,.16),0 3px 6px rgba(0,0,0,.23)!important}div .a-P-d-k,.a-na-d-B1neQd-cb{margin:0;border-radius:5px;padding:5px;width:100%!important;box-sizing:border-box;box-shadow:0 3px 6px rgb(0 0 0 / 16%),0 3px 6px rgb(0 0 0 / 23%)}.e-f-w-Va{width:100%!important}.O-j{padding:.5rem}.O-j-gb{margin:0}.yrk3fc{margin:10px 16px!important}span .h-n-j-Z-ea-aa{margin-top:10px!important}.O-j-Ic-c,.e-f-yb-w-ie,.gpx3nd.Ka-Ia-j,.h-ja-sb{display:none}.PNF6le{text-transform:none!important}img.a-P-d-A,img.a-na-d-A{height:auto!important;width:100%!important;border-radius:.5rem}.h-C-b-i-k{transform:scale(.5)}.h-C-b-i-k .i-F-Rb-k,.e-f-pa,section.e-f-b-x{margin:0}.C-b.e-f-b-x{margin:auto}.e-f-b-j.g-b-j.g-b-j-O{flex-direction:column;height:auto;margin-top:1rem}.F-n-J{position: fixed!important;left: 0px!important;margin-left: -450px;height: 100vh!important;width: 100vw!important;max-width: 450px;z-index: 1149!important;transition: margin .4s ease;}.e-f-n-Va{gap:1rem;align-items:center;justify-content:center}.e-f-w{text-overflow:unset;white-space:break-spaces}.z-J-cGXGTb-Fg-c,.h-z-Ba-ca{margin:0}.h-ba-Eb.ba-Eb.pd-Ye-Qa,.F-ia-k.S-ph.S-Rc-qa{padding:0}article.tNOBCb-b-n-x,article.tNOBCb-b-p-x.tNOBCb-b-p-x-cb{margin:0;padding:0;border:0}.e-f-o,.tNOBCb-b,.Hc-o,.z-J-w-k,span.z-Ha-j{flex-direction:column;gap:.5rem}.C-b-p-j.C-b-p-j-Wd.Ka-Ia-j{flex-direction:column;margin:0;padding:.5rem}.C-b-p-j-kk-dk.Ka-Ia-j{margin:0;margin-top:1rem;padding:.5rem;border:0;border-top:1px solid #f1f3f4}div[role="row"]{display:grid;grid-template-columns:repeat(2, minmax(0, 1fr));gap:.5rem;padding:.5rem}span.e-f-yb-w{flex-direction:column;gap:.5rem;width:calc(100% + 60px);border-radius:.5rem;padding:.5rem;margin-left:calc(-60px - 1rem);background:#f0f0f0}img.e-f-s{margin-right:0;align-self:baseline}.i-Xa-U-S-ti,.C-b-i.i-Xa-U-S.i-Xa-Fa .i-Xa-U-S-ti{width:25px;height:25px}.f-rd>.e-f{min-width:unset;padding:1rem;box-sizing:border-box}.menubutton{float:left;padding:4px display:inline-block;cursor:pointer;z-index:200;}.bar1,.bar2,.bar3{width:25px;height:4px;background-color:#5f6368;margin:3px 0;margin-right:6px;transition:0.4s}.change .bar1{-webkit-transform:rotate(-45deg) translate(-5px,5px);transform:rotate(-45deg) translate(-5px,5px)}.change .bar2{opacity:0}.change .bar3{-webkit-transform:rotate(45deg) translate(-5px,-5px);transform:rotate(45deg) translate(-5px,-5px)}';"
+"document.body.appendChild(node);var menuBtn = document.createElement('div');const sidenav = document.querySelector('.F-n-J');"
+"menuBtn.className = 'menubtn';menuBtn.innerHTML = '<div class=\"bar1\"></div><div class=\"bar2\"></div><div class=\"bar3\"></div>';"
+"const statusNav = document.querySelector('.O-j');var statusS=true;const inputsearchsidenav=document.querySelector('.h-n-j-Qc-lc');"
+"inputsearchsidenav.addEventListener('keypress',(evt)=>{if(evt.keyCode == 13){menuBtn.classList.remove('change');sidenav.classList.remove('showNav');statusS=true;}});"
+"menuBtn.addEventListener('click',()=>{if(statusS){menuBtn.classList.add('change');sidenav.classList.add('showNav');}else{menuBtn.classList.remove('change');sidenav.classList.remove('showNav');}statusS=!statusS;console.log(statusS);}) "
+"statusNav.insertBefore(menuBtn, statusNav.firstChild);"
+"}); })();";
