...
+"console.log(menuBtn);"
+"document.querySelector('.O-j').insertBefore(menuBtn, document.querySelector('.O-j').firstChild);}else{console.log(\"already injected\");}"
+"}); })();";
