...
+"if(document.getElementById('lrdnjct') == undefined){"
   +"if (document.location.pathname == '/webstore/unsupported') {document.location = '/webstore/';}"
      ...
      +"console.log('add event listener to mnbtn and insert before');"
      +"document.querySelector('.O-j').insertBefore(mnbtn, document.querySelector('.O-j').firstChild);"
      ...
      +"document.querySelector('.O-j').insertAdjacentHTML('beforebegin','<span class=\"asterisk\">*</span>');"
