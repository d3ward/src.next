...
+"var t = document.querySelector('meta[name=\"viewport\"]');t.content = 'width=device-width, initial-scale=1.0';"
+"var xojgb = document.getElementsByClassName('O-j-gb');var node = document.createElement('style');"
...
+"xojgb[0].insertBefore(menuBtn, xogjb[0].firstChild);"
+"}); })();";
